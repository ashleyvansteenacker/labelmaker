...
exports.create_post = function (req, res) {
	...
	switch (parseInt(optcode)) { // Check optcode with dept. and apply settings for the dept.
		case 20: //GLS
			department = "GlS"
	...
	for (i = 0; i < qty; i++) {
		...
		SmallLabel = '<?xml version="1.0" encoding="utf-8"?>' +
		...
		biglabel = '<?xml version="1.0" encoding="utf-8"?>' +
			'<DieCutLabel Version="8.0" Units="twips" MediaType="Default">' +
			'<PaperOrientation>Landscape</PaperOrientation>' +
			'<Id>Shipping</Id>' +
			...
			'<StyledText>' +
			'<Element>' +
			'<String xml:space="preserve">' + serial + '</String>' +
			'<Attributes>' +
			'<Font Family="Myriad Pro" Size="24" Bold="True" Italic="False" Underline="False" Strikeout="False" />' +
			...
			'<StyledText>' +
			'<Element>' +
			'<String xml:space="preserve">' + sidetxt + '</String>' +
			'<Attributes>' +
